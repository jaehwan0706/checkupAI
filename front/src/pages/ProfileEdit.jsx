  ...
  return (
    <div data-screen-label="프로필 편집" className="nd-no-scrollbar" style={{ flex: 1, overflow: 'auto', background: T.bg }}>
      ...
      <div style={{ padding: '12px 26px 0', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <div style={{ width: 76, height: 76, borderRadius: 999, background: 'linear-gradient(135deg,#00B894,#4CAF82)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontSize: '1.875rem', fontWeight: 800, position: 'relative' }}>
          {initial}
